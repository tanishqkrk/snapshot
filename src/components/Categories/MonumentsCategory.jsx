...
const MonumentsCategory = () => {
    ...
    useEffect(() => {
        ...
        try {
            fetch(`https://api.unsplash.com/search/photos/?query=monuments&page=${scrollBottom}&per_page=50&client_id=Xkhv6_V5vL4TSH-ZPclJ_S7SqnJxWL1LELDQusZLvVs`)
...
export default MonumentsCategory